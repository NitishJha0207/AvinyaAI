...
import 'package:aiguru/views/chats/Geography/geography_prompt.dart';
import 'package:flutter/material.dart';
import 'dart:io';
import 'package:image_picker/image_picker.dart'; 
import 'package:firebase_vertexai/firebase_vertexai.dart';

class GeographyChatView extends StatefulWidget {
  const GeographyChatView({super.key, required this.title});
  final String title;

  @override
  State<GeographyChatView> createState() => _GeographyChatViewState();
}
...
class _GeographyChatViewState extends State<GeographyChatView> {
