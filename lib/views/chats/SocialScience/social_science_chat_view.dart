import 'package:aiguru/views/chats/SocialScience/socialscience_prompt.dart';
...
class SocialScienceChatView extends StatefulWidget {
  const SocialScienceChatView({super.key, required this.title});
  final String title;

  @override
  State<SocialScienceChatView> createState() => _SocialScienceChatViewState();
}
...
class _SocialScienceChatViewState extends State<SocialScienceChatView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const SocialSciencePrompt(),
    ); 
  }
