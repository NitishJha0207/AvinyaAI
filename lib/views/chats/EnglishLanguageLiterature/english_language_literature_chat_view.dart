...
import 'package:aiguru/views/chats/EnglishLanguageLiterature/english_language_literature_prompt.dart';
import 'package:flutter/material.dart';
import 'dart:io';
import 'package:image_picker/image_picker.dart'; 
import 'package:firebase_vertexai/firebase_vertexai.dart';

class EnglishLanguageLiteratureChatView extends StatefulWidget {
  const EnglishLanguageLiteratureChatView({super.key, required this.title});
  final String title;

  @override
  State<EnglishLanguageLiteratureChatView> createState() => _EnglishLanguageLiteratureChatViewState();
}
...
class _EnglishLanguageLiteratureChatViewState extends State<EnglishLanguageLiteratureChatView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const EnglishLanguageLiteraturePrompt(),
    ); 
  }
}