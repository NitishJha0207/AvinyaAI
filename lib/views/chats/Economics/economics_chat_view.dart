...
import 'package:aiguru/views/chats/Economics/economics_prompt.dart';
import 'package:flutter/material.dart';
import 'dart:io';
import 'package:image_picker/image_picker.dart'; 
import 'package:firebase_vertexai/firebase_vertexai.dart';

class EconomicsChatView extends StatefulWidget {
  const EconomicsChatView({super.key, required this.title});
  final String title;

  @override
  State<EconomicsChatView> createState() => _EconomicsChatViewState();
}
...
class _EconomicsChatViewState extends State<EconomicsChatView> {
