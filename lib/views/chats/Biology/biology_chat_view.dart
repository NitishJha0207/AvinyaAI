...
import 'package:aiguru/views/chats/Biology/biology_prompt.dart';
import 'package:flutter/material.dart';
import 'dart:io';
import 'package:image_picker/image_picker.dart'; 
import 'package:firebase_vertexai/firebase_vertexai.dart';

class BiologyChatView extends StatefulWidget {
  const BiologyChatView({super.key, required this.title});
  final String title;

  @override
  State<BiologyChatView> createState() => _BiologyChatViewState();
}
...
class _BiologyChatViewState extends State<BiologyChatView> {
