...
import 'package:aiguru/views/chats/Hindi/hindi_prompt.dart';
import 'package:flutter/material.dart';
import 'dart:io';
import 'package:image_picker/image_picker.dart'; 
import 'package:firebase_vertexai/firebase_vertexai.dart';

class HindiChatView extends StatefulWidget {
  const HindiChatView({super.key, required this.title});
  final String title;

  @override
  State<HindiChatView> createState() => _HindiChatViewState();
}
...
class _HindiChatViewState extends State<HindiChatView> {
