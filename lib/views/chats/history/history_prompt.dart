...
import 'package:flutter_markdown/flutter_markdown.dart';
 ...
 class HistoryPrompt extends StatefulWidget {
  const HistoryPrompt({super.key});

  @override
  State<HistoryPrompt> createState() => _HistoryPromptState();
}

class _HistoryPromptState extends State<HistoryPrompt> {
  ...
  void initState() {
    ...
    initFirebase().then((value) {
      ...
      _functionCallModel = FirebaseVertexAI.instance.generativeModel(
        ...
        tools: [
          Tool(functionDeclarations: [historyControlTool]),
        ],
      );
  ...
  Future<Map<String, Object?>> learnHistory(
  ...
  final historyControlTool = FunctionDeclaration(
    'learnHistory',
...
Future<void> _testFunctionCalling(String message) async {
    ...
    if (functionCalls.isNotEmpty) {
     ...
     final result = switch (functionCall.name) {
       ...
       'learnHistory' => await learnHistory(functionCall.args),
