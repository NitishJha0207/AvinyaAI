...
import 'package:aiguru/views/chats/BusinessStudies/business_studies_prompt.dart';
import 'package:flutter/material.dart';
import 'dart:io';
import 'package:image_picker/image_picker.dart'; 
import 'package:firebase_vertexai/firebase_vertexai.dart';

class BusinessStudiesChatView extends StatefulWidget {
  const BusinessStudiesChatView({super.key, required this.title});
  final String title;

  @override
  State<BusinessStudiesChatView> createState() => _BusinessStudiesChatViewState();
}
...
class _BusinessStudiesChatViewState extends State<BusinessStudiesChatView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const BusinessStudiesPrompt(),
    ); 
  }
}