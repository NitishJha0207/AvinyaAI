import 'package:aiguru/views/chats/Accountancy/accountancy_prompt.dart';
...
class AccountancyChatView extends StatefulWidget {
  const AccountancyChatView({super.key,required this.title});
  final String title;

  @override
  State<AccountancyChatView> createState() => _AccountancyChatViewState();
}
...
class _AccountancyChatViewState extends State<AccountancyChatView> {
